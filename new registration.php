...
;">
										<div class="caption">
											<i class="fa fa-gift"></i><b>Add New Registration</b>
										</div>										
									</div>
										...
										<form action="" method="POST" name="add_staff" class="form-horizontal">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" name="empl_id" class="form-control" placeholder="Enter Employee Id" required="">														
													</div>
												</div>
											</div>											
											<div class="form-body">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="role"  name="role" class="form-control" placeholder="Enter Role">														
													</div>
												</div>
											</div>
	...
	if(isset($_POST['empl_id']) && isset($_POST['name']) && isset($_POST['department']) && isset($_POST['email']) && isset($_POST['username']) && isset($_POST['password']) && isset($_POST['role']))
	{ 
...
(`empl_id`, `name`, `department`, `email`, `username`, `password`, `role`) 
VALUES 
('$empl_id', '$name', '$department', '$email', '$username', '$password', '$role')");
