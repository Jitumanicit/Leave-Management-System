...
<?php require_once(dirname(__FILE__).'/sidebar.php');?>	
	...
	$get_id=$_GET['id'];
$mysql_select_dealer = $dbhi2->prepare("SELECT * FROM `leave`.`client` WHERE `id`=$get_id");
										...
										<form action="" method="POST" name="add_staff" class="form-horizontal">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['empl_id']; ?>" type="text" readonly="readonly" name="empl_id" class="form-control" placeholder="Enter Employee Id">														
													</div>
												</div>
											</div>
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">Name</label>
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['name']; ?>" type="text"  name="name" readonly="readonly" class="form-control" placeholder="Enter Name">														
													</div>
												</div>
											</div>
                                            ...
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['department']; ?>" type="text" readonly="readonly"  name="department" class="form-control" placeholder="Enter Department">														
													</div>
												</div>
											</div>
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
<input value="<?php echo $db_dealer_value['status']; ?>" type="text"  name="status" class="form-control" placeholder="Enter Status">														
													</div>
												</div>
											</div>
									...
									<button type="submit" class="btn green"	onclick="this.value='Submitting ..';this.disabled='disabled'; this.form.submit();">Update</button>																		  									<!--<button type="button" class="btn default">Cancel</button>-->
										...
										if($_POST)
	{
	if(isset($_POST['empl_id']) && isset($_POST['name']) && isset($_POST['department']) && isset($_POST['status']))
	{ 
	...
	*/
$mysql_update_dealer = $dbhi2->prepare("UPDATE `leave`.`client`
SET `empl_id`='$empl_id',
	`name`='$name',
...
$mysql_update_dealer = $dbhi2->prepare("INSERT INTO `leave`.`emi_table`
SET `empl_id`='$empl_id',
	`name`='$name',
	`department`='$department',
	`status`='$status'
WHERE  `id`=$get_id;");
	$mysql_update_dealer->execute();
							...
							header("location:leave_request.php?show_id=$get_id&update=data_sucessfully_updated");
