...
;">
							<div class="caption">
								<i class="fa fa-user"></i><b>Leave Status</b>
							</div>
						</div>
						...
						$data = datamanager::get_all("client");
							...
							<tr class="odd gradeX">
								...
								<td><?php echo $key['apply_date'];?></td>								
								<td><?php echo $key['status'];?></td>
								<td><a class="btn btn-circle btn-sm blue-stripe" href="leave_view.php?id=<?=$key['id'];?>" >VIEW<span class="glyphicon glyphicon-user"></span></a></td>
