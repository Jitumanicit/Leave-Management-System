...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		<!-- BEGIN LOGO -->
		<div class="page-logo" style="padding-left:1px;">
			<a href="index.html">
			<img src="assets/admin/layout/img/header logo.jpg" alt="" height="45px" width="234px"/>
			</a>
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user" style=" background-color:white;">
					...
					<span class="username username-hide-on-mobile"><font color="#4b8df8"><font size="3.5px"><?php echo current_user('name');?></font></font></span>
