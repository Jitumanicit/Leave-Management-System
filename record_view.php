	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="col-md-6">
					...
					<h5 style="font-size: 15px;">(A Centrally Funded Institute Under Ministry of HRD, Govt. of India)</center></h5>
					<br/>
									...
									<div class="tabbable tabbable-custom tabbable-custom-profile">
											...
											<div class="tab-content">
												<div class="tab-pane active" id="tab_1_11">
													...
													<div class="col-md-6">
														...
														<div class="form-group">
															<label class="control-label col-md-3">Casual Leave:</label>
															<div class="col-md-9">
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">Earned Leave:</label>
															<div class="col-md-8">
																<p class="form-control-static" style="font-size: 15px;">
																<?=$data['total_el'];?>
																</p>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Half Pay Leave:</label>
															<div class="col-md-9">
																<p class="form-control-static" style="font-size: 15px;">
																<?=$data['total_hpl'];?>
																</p>
											...
											<div class="tab-content">
												<div class="tab-pane active" id="tab_1_11">
													<div class="portlet-body">
														...
														<tbody>
												<?php $emi = datamanager::get_all('client', array('empl_id' =>$id));?>	
