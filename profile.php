											...
											<?php $data = datamanager::get_single_row('admin', array('email' =>current_user('email') ))?>
												<form id="form_profile" role="form" action="#">
													<div class="form-group">
														...
														<input type="text" disabled="TRUE"  name="empl_id" value="<?=$data['empl_id'];?>"   class="form-control"/>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input type="text" disabled="TRUE" name="department" value="<?=$data['department'];?>"   class="form-control"/>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input type="text" readonly="readonly" name="email"  value="<?=$data['email'];?>"  class="form-control"/>
													</div>
													<div class="form-group">
